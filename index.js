...
const serverHost = process.env.SERVER_HOST || 'Fixger01-HE15.aternos.me';
const serverPort = parseInt(process.env.SERVER_PORT || '15084', 10);
const botUsername = process.env.BOT_USERNAME || '247_Monitor';
const minecraftVersion = process.env.MC_VERSION || '1.21.4';
